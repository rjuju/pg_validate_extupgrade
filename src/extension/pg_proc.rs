...
use crate::{
    compare::*, elog::*, extension::pg_aggregate::Aggregate, pgdiff::SchemaDiff, pgtype::*,
    proc_prototype, CompareStruct, DbStruct,
};
...
pub fn snap_one_routine(client: &mut Transaction, oid: u32, pgver: u32) -> Routine {
    let sql = format!(
        "SELECT {} \
        FROM pg_proc p \
